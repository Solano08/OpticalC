...
interface GoldenParticleBackgroundProps {
    className?: string;
}

const GoldenParticleBackground: FC<GoldenParticleBackgroundProps> = ({ className = '' }) => {
    ...
    useEffect(() => {
        ...
        const createParticle = (): Particle => {
            ...
            // Orange, Yellow, Gold palette
            if (temp < 0.33) {
                // Orange
                color = { r: 255, g: 140 + Math.random() * 60, b: 0 };
            } else if (temp < 0.66) {
                // Yellow
                color = { r: 255, g: 215 + Math.random() * 40, b: 0 };
            } else {
                // Gold
                color = { r: 255, g: 185 + Math.random() * 30, b: 15 };
            }
